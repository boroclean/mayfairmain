  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg-primary)", color: "var(--text-primary)", padding: "4rem 2rem", display: "flex", justifyContent: "center" }}>
      <div style={{ maxWidth: "800px", width: "100%", background: "var(--bg-secondary)", padding: "4rem", border: "1px solid rgba(212, 175, 55, 0.2)", borderRadius: "8px" }}>
        ...
        {/* Header */}
        <div style={{ textAlign: "center", marginBottom: "3rem", borderBottom: "1px solid rgba(212, 175, 55, 0.2)", paddingBottom: "2rem" }}>
...
Where You cannot provide evidence that the person affected is within the Group due to Attend the Booked Event. 
Telephone or online consultations. 
Where You have not been physically examined by a Registered Medical Doctor before the date of the Booked Event. 
Unpredictable conditions that are unpredictable and circumstances where the Booked Event is more than two months in the future.
Evidence required: 

Registered Medical Doctor’s note or Medical Certificate confirming:
...
Where guidelines for Your pre-existing medical condition would usually prevent You from Attending the Booked Event. 
Telephone or online consultations.
Unpredictable conditions that are unpredictable and the Booked Event is more than two months in the future. 
Pre-existing medical conditions of someone not in the Group who is Attending the Booked Event.
Where You have not been physically examined by a Registered Medical Doctor before the date of the Booked Event.
Registered Medical Doctor’s note or Medical Certificate confirming:
...
Where You cannot provide evidence that the person was Your Immediate Family Member or in the Group due to Attend the Booked Event.
Evidence required:
...
If Your flight is the Booked Event and it is cancelled or postponed, Your refund will not be paid through this service, contact Customer Services. 
If You were aware of the disruption prior to the date of the Booked Event and did not make reasonable, suitable alternative travel arrangements. 
If there is a financial failure of any Transport provider. 
If the purpose or reason for which You booked Your flight to Attend the Booked Event has been altered or cancelled.
...
Any vehicle You plan to use during the Booked Event.
Evidence required: 
...
If the documents can be replaced in advance of the Booked Event or on the day of the Booked Event.
Lost documents.
Evidence required: 
...
Voluntary relocation or when You are changing employers for a new role. 
Where You are the business owner or registered Director, or where a member of Your family is.
Evidence required: 
...
You were aware of or had scheduled work on the date of the Booked Event, prior to making the Booking. 
...
Anything which Our Customer Service Team considers is not intended to be included in this list of valid reasons for a refund. 
...
Naturalisation, visa, fertility treatment, or any other appointments.
